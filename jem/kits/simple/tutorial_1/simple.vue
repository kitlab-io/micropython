...
module.exports = {
  ...
  buzz()
  {
    // call the buzz function we defined in simple.py at 200 hertz for 2 seconds then stop
    this.parent.device.send("kit._kit.buzz(freq_hz=200, time_sec=2)\n\r");
  },
  // Tutorial_1 !
