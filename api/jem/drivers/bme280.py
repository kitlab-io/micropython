...
Desc: Bosch bme280 Barometric pressure, humidity and temperature sensor
...
class BME280:
    ...
    def __init__(self, i2c=None, address=I2C_ADDRESS, mode=BME280_OSAMPLE_8):
    ...
    def get_altitude_from_pressure(self, p_pa):
        '''
        Altitude in m.
        '''
        from math import pow
        try:
            p = 44330 * (1.0 - pow(p_pa / self.__sealevel, 0.1903))
        except:
            p = 0.0
        return p
    ...
    def data(self):
        ...
        p = p / 256.0
        h = h / 1024.0
        a = self.get_altitude_from_pressure(p)
        return t, p, h, a
